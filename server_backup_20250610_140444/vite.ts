...
export async function setupVite(app: Express, server: Server): Promise<void> {
  ...
  // Aplicar middleware do Vite, mas não nas rotas da API
  ...
  app.use("*", async (req, res, next) => {
    ...
    // Não interceptar rotas da API ou estáticas
    if (url.startsWith("/api") || url.startsWith("/static") || url.startsWith("/assets")) {
      return next();
    }
